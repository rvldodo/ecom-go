...
import (
	...
	_ "github.com/dodo/ecom/cmd/goose/migrations"
...
const (
	defaultMigrationDir = "cmd/goose/migrations"
)
...
func main() {
	...
	command := args[0]
	dbstring := config.Envs.DBUser + ":" + config.Envs.DBPassword + "@tcp(" + config.Envs.DBAddress + ")/" + config.Envs.DBName
